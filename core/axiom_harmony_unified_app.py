  ...
  <main>
    ...
    var _IL_HO = {
      ...
      sw: {
        ...
        "Talk with a licensed professional": "Zungumza na mtaalamu mwenye leseni",
        "Start a video session with a counselor": "Anza kikao cha video na mshauri",
        "Schedule a session for later": "Panga kikao cha baadaye",
        "Want me to share a short summary with the counselor so your time together starts with them already understanding you?": "Unataka nishiriki muhtasari mfupi na mshauri, ili muda wenu uanze akiwa tayari anakuelewa?",
        "Find free/low-cost legal help near me": "Tafuta msaada wa kisheria wa bure/gharama nafuu karibu nami",
        "Save my questions for the attorney": "Hifadhi maswali yangu kwa wakili",
        "Want me to prepare a summary of your situation and the questions to ask, so you're ready when you talk to an attorney?": "Unataka nitayarishe muhtasari wa hali yako na maswali ya kuuliza, ili uwe tayari unapozungumza na wakili?",
        "Connect to local resources": "Unganishwa na rasilimali za eneo lako",
        "find food assistance near me": "tafuta msaada wa chakula karibu nami",
        "find emergency shelter near me": "tafuta makazi ya dharura karibu nami",
        "Want me to note what you need so the resource line can help you faster?": "Unataka niandike unachohitaji ili laini ya rasilimali ikusaidie haraka zaidi?",
        "@who:a tenant rights / housing attorney": "wakili wa haki za wapangaji/makazi",
        "@who:a housing and benefits advocate": "mtetezi wa makazi na mafao",
        "@who:an employment attorney": "wakili wa masuala ya ajira",
        "@who:an employment discrimination attorney (EEOC matters)": "wakili wa ubaguzi kazini (masuala ya EEOC)",
        "@who:a family law attorney": "wakili wa sheria za familia",
        "@who:a family law / custody attorney": "wakili wa familia/malezi ya watoto",
        "@who:a domestic violence advocate and protective-order attorney": "mtetezi wa unyanyasaji wa nyumbani na wakili wa amri za ulinzi",
        "@who:a criminal defense attorney or public defender": "wakili wa utetezi wa jinai au wakili wa umma",
        "@who:a qualified immigration attorney (not a notario)": "wakili wa uhamiaji aliyehitimu (si notario)",
        "@who:an education rights attorney": "wakili wa haki za elimu",
        "@who:a patient rights / health law advocate": "mtetezi wa haki za mgonjwa/sheria za afya",
        "@who:a disability rights attorney": "wakili wa haki za walemavu",
        "@who:a consumer protection attorney": "wakili wa ulinzi wa mlaji",
        "@who:a civil rights attorney": "wakili wa haki za kiraia",
      ...
      am: {
        ...
        "Talk with a licensed professional": "ፈቃድ ካለው ባለሙያ ጋር ይነጋገሩ",
        "Start a video session with a counselor": "ከአማካሪ ጋር የቪዲዮ ክፍለ ጊዜ ይጀምሩ",
        "Schedule a session for later": "ለበኋላ ክፍለ ጊዜ ያስይዙ",
        "Want me to share a short summary with the counselor so your time together starts with them already understanding you?": "አማካሪው አስቀድሞ እርስዎን ተረድቶ ጊዜያችሁ እንዲጀምር አጭር ማጠቃለያ እንዳካፍል ይፈልጋሉ?",
        "Find free/low-cost legal help near me": "በአቅራቢያዬ ነፃ/በዝቅተኛ ወጪ የሕግ እርዳታ ፈልግ",
        "Save my questions for the attorney": "ጥያቄዎቼን ለጠበቃ አስቀምጥ",
        "Want me to prepare a summary of your situation and the questions to ask, so you're ready when you talk to an attorney?": "ከጠበቃ ጋር ሲነጋገሩ ዝግጁ እንዲሆኑ የሁኔታዎን ማጠቃለያና የሚጠየቁ ጥያቄዎችን እንዳዘጋጅ ይፈልጋሉ?",
        "Connect to local resources": "ከአካባቢ ግብዓቶች ጋር ይገናኙ",
        "find food assistance near me": "በአቅራቢያዬ የምግብ ድጋፍ ፈልግ",
        "find emergency shelter near me": "በአቅራቢያዬ የአደጋ ጊዜ መጠለያ ፈልግ",
        "Want me to note what you need so the resource line can help you faster?": "የግብዓት መስመሩ በፍጥነት እንዲረዳዎ የሚፈልጉትን እንድመዘግብ ይፈልጋሉ?",
        "@who:a tenant rights / housing attorney": "የተከራይ መብት/የመኖሪያ ጠበቃ",
        "@who:a housing and benefits advocate": "የመኖሪያና ጥቅማጥቅም ተሟጋች",
        "@who:an employment attorney": "የሥራ ቅጥር ጠበቃ",
        "@who:an employment discrimination attorney (EEOC matters)": "የሥራ ላይ መድልዎ ጠበቃ (የEEOC ጉዳዮች)",
        "@who:a family law attorney": "የቤተሰብ ሕግ ጠበቃ",
        "@who:a family law / custody attorney": "የቤተሰብ/የልጅ ጥበቃ ጠበቃ",
        "@who:a domestic violence advocate and protective-order attorney": "የቤት ውስጥ ጥቃት ተሟጋችና የመከላከያ ትእዛዝ ጠበቃ",
        "@who:a criminal defense attorney or public defender": "የወንጀል መከላከያ ጠበቃ ወይም የሕዝብ ተከላካይ",
        "@who:a qualified immigration attorney (not a notario)": "ብቁ የስደተኞች ጉዳይ ጠበቃ (ኖታሪዮ አይደለም)",
        "@who:an education rights attorney": "የትምህርት መብት ጠበቃ",
        "@who:a patient rights / health law advocate": "የታካሚ መብት/የጤና ሕግ ተሟጋች",
        "@who:a disability rights attorney": "የአካል ጉዳተኞች መብት ጠበቃ",
        "@who:a consumer protection attorney": "የሸማች ጥበቃ ጠበቃ",
        "@who:a civil rights attorney": "የዜጎች መብት ጠበቃ",
      ...
      ha: {
        ...
        "Talk with a licensed professional": "Yi magana da ƙwararre mai lasisi",
        "Start a video session with a counselor": "Fara zaman bidiyo da mai ba da shawara",
        "Schedule a session for later": "Shirya zama don gaba",
        "Want me to share a short summary with the counselor so your time together starts with them already understanding you?": "Kana so in raba taƙaitaccen bayani da mai ba da shawara, don lokacinku ya fara yana riga ya fahimce ka?",
        "Find free/low-cost legal help near me": "Nemo taimakon shari'a kyauta/mai rahusa kusa da ni",
        "Save my questions for the attorney": "Ajiye tambayoyina don lauya",
        "Want me to prepare a summary of your situation and the questions to ask, so you're ready when you talk to an attorney?": "Kana so in shirya taƙaitaccen halin da kake ciki da tambayoyin da za a yi, don ka shirya sa'ad da za ka yi magana da lauya?",
        "Connect to local resources": "Haɗa da albarkatun yankinka",
        "find food assistance near me": "nemo taimakon abinci kusa da ni",
        "find emergency shelter near me": "nemo mafakar gaggawa kusa da ni",
        "Want me to note what you need so the resource line can help you faster?": "Kana so in rubuta abin da kake bukata don layin albarkatu ya taimake ka da sauri?",
        "@who:a tenant rights / housing attorney": "lauyan haƙƙin haya/gidaje",
        "@who:a housing and benefits advocate": "mai taimako kan gidaje da alawus",
        "@who:an employment attorney": "lauyan aiki",
        "@who:an employment discrimination attorney (EEOC matters)": "lauyan nuna bambanci a aiki (al'amuran EEOC)",
        "@who:a family law attorney": "lauyan dokar iyali",
        "@who:a family law / custody attorney": "lauyan iyali/rikon yara",
        "@who:a domestic violence advocate and protective-order attorney": "mai taimako kan cin zarafi a gida da lauyan umarnin kariya",
        "@who:a criminal defense attorney or public defender": "lauyan kare masu laifi ko lauyan gwamnati",
        "@who:a qualified immigration attorney (not a notario)": "kwararren lauyan shige da fice (ba notario ba)",
        "@who:an education rights attorney": "lauyan haƙƙin ilimi",
        "@who:a patient rights / health law advocate": "mai taimako kan haƙƙin majiyyaci/dokar lafiya",
        "@who:a disability rights attorney": "lauyan haƙƙin nakasassu",
    ...
    <section id="story-screen" class="story-screen" style="display:none;">
      ...
      <div class="scene-picker" id="scene-picker" role="group" aria-label="Background scene">
        ...
        <button class="scene-btn" data-scene="chilis" onclick="setScene('chilis')" title="Chili peppers" aria-label="Chili peppers scene">&#127798;</button>
        <button class="scene-btn" data-scene="rosemarymist" onclick="setScene('rosemarymist')" title="Rosemary in the mist" aria-label="Rosemary in the mist scene">&#128167;</button>
...
const SCENE_PHOTOS = {
  ...
  // Founder's night photographs (Aug 2026). NOTE: received as small
  // thumbnails and upscaled — replace with full-resolution originals
  ...
  chilis:    '/scenes/photo_22_chilis.jpg',
  rosemarymist:'/scenes/photo_23_rosemary_mist.jpg',
...
const SCENE_ORDER = ['garden','lettuce','pepper','redpepper','sunflower','sunflowers','sunset','horizon','wave','moon','daymoon','moonleaf','pinestars','moonhaze','pumpkin','canopy','pumpkinbed','strawberry','bougainvillea','trunks','peaches','chilis','rosemarymist'];
...
var _IL_AN = {
  ...
  sw:{hint:'gusa mwanga — mdundo utakufuata', close:'Niko sawa kwa sasa', pill:'Kaza fikira nami',
      stay:'… baki nami.', words:['niko hapa.','pamoja nawe.','vuta pumzi…','na utoe…','uko salama.','baki nami.']},
    ...
    fetch('/api/zenisys/ambient?emotion=' + encodeURIComponent(emo))
      ...
      .then(d => {
        ...
        if (tracks.length) {
          ...
          if (!sceneUserChose){
            const sceneFor = { deepcalm: ['moon','moonleaf','pinestars','moonhaze','horizon','g_moonleaf_night','g_daymoon_night','g_moonleaf_dream','g_wave_dream', 'rosemarymist'],
